...
*/
 ...
 if($name!="" && $regno!= "" && $dob!="" && $gender!="" && $email!="" && $phone!="" && $course!= "" && $photoName!="")
 {
    $query="update forms set name='$name',regno='$regno',dob='$dob',gender='$gender',email='$email',phone='$phone',course='$course' ,photo='$photoName'where id='".$_GET['id']."' ";
            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" autocomplete="off">
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="regno" value="<?php echo $row['regno']; ?>">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dob" value="<?php echo $row['dob']; ?>">
                        ...
                        <div class="input-group">
                            <label class="label"><b>ourse</b><span class= "error">*</span></label>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="course" selected="selected">
